...
func (x *DrainTask) Reset() {
	*x = DrainTask{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_main_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DrainTask) Descriptor() ([]byte, []int) {
	return file_pb_main_proto_rawDescGZIP(), []int{7}
}
...
func (x *DrainTaskList) Reset() {
	*x = DrainTaskList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_main_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DrainTaskList) Descriptor() ([]byte, []int) {
	return file_pb_main_proto_rawDescGZIP(), []int{8}
}
...
var file_pb_main_proto_rawDesc = []byte{
	...
	,
...
var file_pb_main_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_pb_main_proto_goTypes = []interface{}{
	...
	(*Task)(nil),           // 6: Task
	(*DrainTask)(nil),      // 7: DrainTask
	(*DrainTaskList)(nil),  // 8: DrainTaskList
}
var file_pb_main_proto_depIdxs = []int32{
	5, // 0: TaskResponse.Tasks:type_name -> TreeTask
	6, // 1: TreeTask.Task:type_name -> Task
	7, // 2: DrainTaskList.tasks:type_name -> DrainTask
	3, // 3: UltraQueueInternal.Dequeue:input_type -> DequeueRequest
	1, // 4: UltraQueueInternal.Ack:input_type -> AckRequest
	2, // 5: UltraQueueInternal.Nack:input_type -> NackRequest
	8, // 6: UltraQueueInternal.DrainReceive:input_type -> DrainTaskList
	4, // 7: UltraQueueInternal.Dequeue:output_type -> TaskResponse
	0, // 8: UltraQueueInternal.Ack:output_type -> Applied
	0, // 9: UltraQueueInternal.Nack:output_type -> Applied
	0, // 10: UltraQueueInternal.DrainReceive:output_type -> Applied
...
func file_pb_main_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_main_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DrainTask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_main_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DrainTaskList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
